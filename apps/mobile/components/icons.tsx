...
export function TypeIcon({ type, size = 20, color = "rgba(255,255,255,0.4)" }: TypeIconProps) {
  return (
...
export function StarIcon({ size = 16, color = "#d4b08c" }: IconProps) {
  return (
...
export function StarOutlineIcon({ size = 16, color = "rgba(255,255,255,0.2)" }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
...
export function CopyIcon({ size = 18, color = "rgba(255,255,255,0.5)" }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
        d="M15.75 17.25v3.375c0 .621-.504 1.125-1.125 1.125h-9.75a1.125 1.125 0 01-1.125-1.125V7.875c0-.621.504-1.125 1.125-1.125H6.75m10.5-2.25h.008v.008h-.008V4.5zm0 0a2.25 2.25 0 012.25 2.25v10.5a2.25 2.25 0 01-2.25 2.25h-2.25m0-15h-7.5A2.25 2.25 0 007.5 6.75v10.5"
        stroke={color}
        strokeWidth={1.5}
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function EyeIcon({ size = 18, color = "rgba(255,255,255,0.5)" }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
...
export function EyeSlashIcon({ size = 18, color = "rgba(255,255,255,0.5)" }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
...
export function ChevronRightIcon({ size = 20, color = "rgba(255,255,255,0.3)" }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
...
export function ChevronDownIcon({ size = 20, color = "rgba(255,255,255,0.3)" }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
...
export function PencilIcon({ size = 20, color = "#d4b08c" }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
...
export function XIcon({ size = 20, color = "rgba(255,255,255,0.5)" }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
...
export function TagIcon({ size = 14, color = "rgba(255,255,255,0.4)" }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
