		...
		<article className="py-12">
			...
			<Section id="features" title="Features">
				<div className="space-y-8">
					<div>
						<h3 id="one-time-links" className="text-xl font-semibold mb-3 text-black">one-time links</h3>
						<p className="text-black/60 max-w-2xl">
					...
					<div>
						<h3 id="e2e-encryption" className="text-xl font-semibold mb-3 text-black">end-to-end encryption</h3>
						<p className="text-black/60 max-w-2xl">
					...
					<div>
						<h3 id="cli-tool" className="text-xl font-semibold mb-3 text-black">CLI tool</h3>
						<p className="text-black/60 max-w-2xl">
					...
					<div>
						<h3 id="file-sharing" className="text-xl font-semibold mb-3 text-black">file sharing</h3>
						<p className="text-black/60 max-w-2xl">
							upload and share encrypted files up to 5MB. perfect for sharing certificates, keys, and other sensitive files.
						</p>
					</div>
					<div>
						<h3 id="view-limits" className="text-xl font-semibold mb-3 text-black">view limits</h3>
						<p className="text-black/60 max-w-2xl">
							set how many times a secret can be viewed before it&apos;s deleted. useful when sharing with multiple team members.
						</p>
					</div>
					<div>
						<h3 id="expiry" className="text-xl font-semibold mb-3 text-black">auto-expiry</h3>
						<p className="text-black/60 max-w-2xl">
			...
			<section className="mb-12">
				...
				<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
					<Link href="/docs/cli" className="block border border-black/10 rounded-xl p-6 hover:bg-black/5 transition-colors">
						<h3 className="font-semibold mb-2 text-black">CLI</h3>
						<p className="text-sm text-black/50">share secrets from terminal</p>
					</Link>
					<Link href="/docs/web" className="block border border-black/10 rounded-xl p-6 hover:bg-black/5 transition-colors">
						<h3 className="font-semibold mb-2 text-black">Web</h3>
						<p className="text-sm text-black/50">use the website interface</p>
					</Link>
					<Link href="/docs/encryption" className="block border border-black/10 rounded-xl p-6 hover:bg-black/5 transition-colors">
						<h3 className="font-semibold mb-2 text-black">Encryption</h3>
						<p className="text-sm text-black/50">how we keep your data safe</p>
					</Link>
				</div>
			</section>
		</article>
