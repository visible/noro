		...
		<article className="py-12">
			...
			<Section id="create" title="Create a secret">
				<p className="text-black/60 mb-4 max-w-2xl">
					go to <a href="/share" className="text-[#C53D43] hover:underline">noro.sh/share</a> and paste your secret.
				</p>
				<p className="text-black/60 mb-4 max-w-2xl">
					choose your options:
				</p>
				<ul className="space-y-2 text-black/60 max-w-2xl">
					<li className="flex items-start gap-2">
						...
						<span><strong className="text-black">type:</strong> text or file</span>
					</li>
					<li className="flex items-start gap-2">
						<span className="text-[#C53D43]">•</span>
						<span><strong className="text-black">expiry:</strong> how long until auto-delete</span>
					</li>
					<li className="flex items-start gap-2">
						<span className="text-[#C53D43]">•</span>
						<span><strong className="text-black">views:</strong> how many times it can be viewed (1-5)</span>
					</li>
				</ul>
